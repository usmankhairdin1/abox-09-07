  ...
  return (
    <div className="relative">
      ...
      <div className="pointer-events-none fixed inset-x-0 bottom-0 z-50 flex justify-center p-3">
        <div className="pointer-events-auto flex max-w-full flex-wrap items-center gap-2 rounded-full border border-hairline bg-popover/95 px-3 py-2 shadow-[var(--shadow-overlay)] backdrop-blur">
          ...
          {prev ? (
            <Link
              to="/hf/$screen"
              params={{ screen: prev }}
              className="rounded-full border border-hairline px-2 py-0.5 text-xs hover:bg-accent"
            >
              ←
            </Link>
          ) : null}
