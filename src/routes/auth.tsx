        ...
        <form onSubmit={submit} className="mt-3 flex flex-col gap-2.5">
          <label className="flex flex-col gap-1 text-[11px] font-medium uppercase tracking-wider text-muted-foreground">
            ...
            <input
              ...
              className="rounded-md border border-border bg-background px-2.5 py-2 text-sm normal-case tracking-normal text-foreground"
            />
          </label>
          <label className="flex flex-col gap-1 text-[11px] font-medium uppercase tracking-wider text-muted-foreground">
            Password
          ...
          <button
            type="submit"
            disabled={busy}
            className="mt-1 rounded-md bg-primary px-3 py-2 text-xs font-semibold text-primary-foreground disabled:opacity-50"
          >
