...
function Page() {
  ...
  return (
    <InternalShell
      ...
      actions={<button onClick={() => marketplaceStore.recalculateReadiness()} className="inline-flex h-10 items-center gap-1.5 rounded-full bg-primary px-4 text-sm font-medium text-primary-foreground hover:bg-primary/90"><RotateCw className="h-4 w-4" aria-hidden /> Recalculate</button>}
    >
      {readiness ? (
