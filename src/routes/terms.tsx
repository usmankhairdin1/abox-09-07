...
export const Route = createFileRoute("/terms")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "The terms that govern your use of the ABox marketplace, Plan-O guidance, and connected services." },
...
const SECTIONS = [
  ...
  { h: "3. Plan-O is educational", body: "Plan-O provides trade-off explanations and general information. It is not legal, tax, medical, or licensed insurance advice. Consult a licensed agent for advice." },
