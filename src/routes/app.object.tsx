...
export const Route = createFileRoute("/app/object")({
  head: () => ({
    meta: [
      { title: "Object Page Framework — Agency in a Box" },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "Object Page Framework — Agency in a Box" },
      {
  ...
  return (
    ...
    >
      ...
      <WPanel
        ...
        meta="Switch record type to see the shared object layout in use"
      >
