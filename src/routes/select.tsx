 ...
 * Consumers pick a product and choose PlanAI guided vs Browse Myself.
 */
    ...
    <MarketplaceShell product={active.key}>
      <div className="mx-auto max-w-7xl px-4 pb-12 pt-6 md:px-8 md:pb-16 md:pt-8">
        <PageHeader
          ...
          description="PlanAI guides you through a short quote and shortlists plans. Or browse everything yourself — you can switch anytime."
        />
        ...
        <div className="grid gap-4 md:grid-cols-2">
          ...
          >
            ...
            <div>
              ...
              <h3 className="text-display mt-1 text-2xl">Guide me with PlanAI</h3>
              <p className="mt-2 text-sm text-muted-foreground">
                Answer 6 short questions. PlanAI narrows the list to plans that fit — with a subsidy check on the way.
              </p>
          ...
          >
            ...
            <div>
              ...
              <p className="mt-2 text-sm text-muted-foreground">
                Jump straight to plans. Add filters, compare, and add to cart — PlanAI stays available on the side.
              </p>
              <ul className="mt-4 space-y-1.5 text-sm">
        ...
        <p className="mt-8 text-xs text-muted-foreground">
          PlanAI guidance is educational and non-binding. You can switch between guided and self-serve at any time.
        </p>
      </div>
    </MarketplaceShell>
  );
