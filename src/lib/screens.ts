...
export const SCREENS: Record<string, ScreenMeta> = {
  ...
  "UX-002": { id: "UX-002", name: "Product Selection & Path Choice", workspace: "marketplace", phase: "m1",
    purpose: "Choose PlanAI guided vs Browse Myself after selecting product." },
  ...
  "UX-005": { id: "UX-005", name: "PlanAI — Goals & Usage", workspace: "marketplace", phase: "m1",
    purpose: "Priority ranking, expected usage, doctor match, PlanAI worksheet." },
  ...
  "UX-010": { id: "UX-010", name: "Plan Detail", workspace: "marketplace", phase: "m1",
    purpose: "Benefits, costs, network + Rx, PlanAI explanation, add to cart / compare." },
  ...
  "UX-016": { id: "UX-016", name: "Consumer Dashboard", workspace: "member", phase: "m1",
    purpose: "Saved quotes, carts, applications, tasks, messages; PlanAI resume summary." },
  ...
  "UX-018": { id: "UX-018", name: "Agent Quick Quote — Workspace", workspace: "agent", phase: "m1",
    purpose: "Compact quote input, results panel, PlanAI assist, send/add/request follow-up." },
  ...
  "UX-025": { id: "UX-025", name: "Module 1 Config — Routing & Notifications", workspace: "jet", phase: "m1",
    purpose: "Routing basics; channel/template basics; scheduling availability; PlanAI on/off." },
  ...
  "SCR_JET_AI_GOV": { id: "SCR_JET_AI_GOV", name: "AI / PlanAI Governance", workspace: "jet", phase: "phase1",
