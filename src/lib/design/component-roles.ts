...
export const COMPONENT_FOUNDATION_ROLES: ComponentRoleSpec[] = [
  {
    ...
    roles: [
      ...
      { slot: "Action foreground", foundation: "action/primary-on", current: "text-primary-foreground" },
      ...
      { slot: "Focus ring", foundation: "state/focus-ring", current: "focus-visible:ring-1 ring-ring" },
      ...
      { slot: "Elevation", foundation: "elevation/raised-subtle", current: "shadow / shadow-sm per variant" },
    ],
  },
  {
    component: "Input",
    ...
    roles: [
      ...
      { slot: "Placeholder", foundation: "content/secondary", current: "placeholder:text-muted-foreground" },
      { slot: "Focus ring", foundation: "state/focus-ring", current: "focus-visible:ring-1 ring-ring" },
      { slot: "Disabled", foundation: "opacity/disabled", current: "disabled:opacity-50" },
      { slot: "Typography", foundation: "type/body", current: "text-base md:text-sm" },
      { slot: "Height", foundation: "control/compact", current: "h-9" },
      { slot: "Helper / error", foundation: "status/danger", current: "Not owned by the primitive" },
    ],
    note: "Helper and error text are written at each call site; no shared field component owns them.",
  },
  {
    component: "Card",
    source: "src/components/ui/card.tsx and the ABox card pattern — 6 primitive consumers, 264 bg-card occurrences",
    label: "FUTURE CANONICAL TARGET",
    roles: [
      ...
      { slot: "Internal spacing", foundation: "space/500", current: "p-5, with p-4 and p-6 variants" },
  ...
  },
  {
    ...
    label: "FUTURE CANONICAL TARGET",
    roles: [
      { slot: "Tone", foundation: "status/<role>", current: "--tone set from sage, primary, warning, muted, destructive or info" },
      { slot: "Background", foundation: "status/<role>-subtle", current: "color-mix tone 12% over card" },
      { slot: "Foreground", foundation: "status/<role>-on-subtle", current: "color-mix tone 88% with foreground" },
      { slot: "Border", foundation: "status/<role>-line", current: "color-mix tone 34% with transparent" },
      { slot: "Indicator dot", foundation: "status/<role>", current: "solid 6px dot at full tone" },
      { slot: "Typography", foundation: "type/micro-label", current: "text-[10px] font-semibold uppercase tracking-[0.12em]" },
  ...
  },
  {
    ...
    roles: [
      ...
      { slot: "Tier foreground", foundation: "tier/<name>-on", current: "--metal-<name>-fg, chosen per tier" },
      { slot: "Typography", foundation: "type/micro-label", current: "uppercase micro label" },
      { slot: "Radius", foundation: "radius/full", current: "rounded-full" },
      { slot: "Opacity", foundation: "none", current: "always full opacity, in filters and listings alike" },
    ],
  },
  {
    ...
    label: "FUTURE CANONICAL TARGET",
    roles: [
      { slot: "Title", foundation: "type/page-title", current: "display family, compact variant reduced" },
      ...
      { slot: "Spacing", foundation: "space/relationship title→supporting", current: "mt-1 to mt-3" },
    ],
  },
  {
    component: "DataTable",
    ...
    label: "FUTURE CANONICAL TARGET",
    roles: [
      { slot: "Shell surface", foundation: "surface/raised", current: "bg-card with a hairline border" },
      { slot: "Head typography", foundation: "type/table-head", current: "10px uppercase tracked muted" },
  ...
  },
  {
    ...
    roles: [
      ...
      { slot: "Surface", foundation: "surface/raised", current: "card or bare region depending on the call site" },
    ],
  ...
  },
  {
    ...
    label: "FUTURE CANONICAL TARGET",
    roles: [
      { slot: "Surface", foundation: "surface/raised", current: "card surface with a hairline ring" },
      { slot: "Typography", foundation: "type/action", current: "text-sm font-medium" },
      { slot: "Radius", foundation: "radius/full", current: "rounded-full" },
  ...
  },
  {
    ...
    roles: [
      ...
      { slot: "Elevation", foundation: "elevation/elevated or drawer", current: "--shadow-elevated, --shadow-drawer" },
      { slot: "Radius", foundation: "radius/card", current: "shadcn default" },
      { slot: "Section spacing", foundation: "space/relationship dialog", current: "primitive defaults" },
    ],
  },
];
