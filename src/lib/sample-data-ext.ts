...
export const SAMPLE_NOTIF_TEMPLATES: SampleNotifTemplate[] = [
  ...
  { id: "NT-04", name: "PlanAI follow-up nudge", channel: "in-app", trigger: "plano.abandoned", schedule: "T+24h", enabled: false, lastSent: "—" },
...
export const SAMPLE_AI_RULES: SampleAiRule[] = [
  { id: "AR-01", scope: "tenant", name: "PlanAI guidance", enabled: true, disclaimer: "Educational, not binding.", escalation: "auto-hand-off" },
